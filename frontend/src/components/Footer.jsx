        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              RideLink connects passengers with drivers traveling the same
              route, making intercity travel affordable, safe, and
              community-driven.
            </p>
            <div className="flex items-center gap-3.5 pt-2">
              <a
                href="#"
                className="p-2 bg-slate-800 hover:bg-primary-blue hover:text-white rounded-lg transition-colors"
                aria-label="Twitter"
              >
                <svg
