  ...
  const slides = [
    {
      ...
      title: "Need a Ride?",
      description:
        "Find drivers already traveling your route. Request a seat, meet at a convenient location, and travel together safely.",
    },
    {
      icon: <Car size={56} className="text-brand-success" />,
      title: "Driving somewhere?",
      description:
        "Publish your ride and receive passenger requests. Share your route and offset fuel expenses with trusted passengers.",
    },
    {
      icon: <ShieldCheck size={56} className="text-amber-500" />,
      title: "Travel Together",
      description:
        "Share fuel and toll costs safely with verified users. Check driver profiles, ratings, and active statuses before booking.",
    },
  ];
