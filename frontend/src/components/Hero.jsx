    ...
    <div className="relative min-h-[85vh] flex flex-col items-center justify-center pt-20 pb-16 overflow-hidden bg-gradient-to-b from-blue-50/40 via-white to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10 flex flex-col items-center justify-center text-center space-y-12">
        ...
        <div className="space-y-4 max-w-3xl">
          ...
          >
            Welcome to RideLink. Whether you are driving your car or looking for
            a ride, get to your destination together easily, affordably, and
            safely.
          </motion.p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-secondary-text leading-relaxed">
                  Traveling from one city to another? Publish your trip and let
                  passengers traveling on your route request a seat.
                </p>
              </div>
            </div>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-secondary-text leading-relaxed">
                  Search for drivers already traveling your route and request a
                  seat in seconds. Filter by date, route, or price.
                </p>
              </div>
            </div>
