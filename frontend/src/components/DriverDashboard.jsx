    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-3 bg-white border border-brand-border rounded-3xl p-4 space-y-1.5 shadow-sm">
          ...
          <div className="px-1 mb-2">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-2.5 px-4 bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-extrabold rounded-xl transition-all border border-slate-200"
            >
        ...
        <div className="lg:col-span-9 space-y-6">
          ...
          {/* TAB: OFFER RIDE */}
          {activeSubTab === "offerRide" && user.isDriver && (
            <motion.div
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              className="space-y-6"
            >
              <div className="bg-white border border-brand-border rounded-3xl p-6 sm:p-8 shadow-sm text-left">
                <div className="mb-6">
                  <h3 className="text-lg font-bold text-primary-text">
                    Offer Your Ride
                  </h3>
                  <p className="text-xs text-secondary-text">
                    List your route details, set price, and split trip expenses.
                  </p>
                </div>
                ...
                <form onSubmit={handlePublishRide} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      disabled
                      value={`${user.vehicleDetails?.model || "Tesla Model 3"} (${user.vehicleDetails?.color || "Midnight Blue"})`}
                      className="w-full px-3.5 py-2.5 bg-slate-100 border border-brand-border rounded-xl text-xs text-secondary-text font-semibold cursor-not-allowed"
                    />

                    <p className="text-[9px] text-slate-400 mt-1">
                      Vehicle specs are prefilled from your Driver Verification
                      profile.
                    </p>
                  </div>
          ...
          {activeSubTab === "trips" && (
            <div className="bg-white border border-brand-border rounded-3xl p-6 shadow-sm space-y-6">
              <div>
                ...
                <p className="text-xs text-secondary-text">
                  Manage all details for your upcoming and past routes.
                </p>
              </div>
              <div className="space-y-4">
                {user.isDriver ? (
                      ...
                      >
                        <div>
                          <div className="flex items-center gap-2 mb-1.5">
                            ...
                            <span className="px-2 py-0.5 bg-blue-50 text-[10px] font-bold text-primary-blue rounded-md uppercase">
                              {ride.status}
                            </span>
                          </div>
                          <div className="flex items-center gap-4 text-xs text-secondary-text">
                            ...
                            <span className="flex items-center gap-1">
                              <Users size={13} /> {ride.seatsAvailable} seats
                            </span>
                          </div>
                          <div className="mt-2 pt-1">
                            <a
                              ...
                              className="inline-flex items-center gap-1.5 px-2.5 py-1.5 bg-slate-900 hover:bg-slate-850 text-white text-[10px] font-bold rounded-lg transition-all"
                            >
                              <Compass size={11} /> Start Navigation
                            </a>
                          </div>
                        </div>
          ...
          {activeSubTab === "passengerRequests" && user.isDriver && (
            <div className="bg-white border border-brand-border rounded-3xl p-6 shadow-sm space-y-6">
              <div>
                ...
                <p className="text-xs text-secondary-text">
                  These passengers need a ride on routes you might be driving.
                  Send them an offer.
                </p>
              </div>

              <div className="space-y-4">
                {passengerRequests.filter((r) => r.status === "searching")
                  .length === 0 ? (
                  <div className="text-center py-12 bg-slate-50 border border-brand-border rounded-2xl border-dashed">
                    ...
                    <p className="text-xs text-slate-400 mt-0.5">
                      When passengers request rides on the platform, they'll
                      show up here.
                    </p>
                  </div>
                ) : (
                  passengerRequests
                    ...
                    .map((req) => (
                      <div
                        key={req.id}
                        className="p-5 bg-slate-50 border border-brand-border rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-left"
                      >
                              ...
                              <div className="flex items-center gap-2 text-[10px] text-slate-400 mt-0.5 font-semibold">
                                <span className="flex items-center gap-0.5">
                                  <Star
                                    ...
                                    className="fill-amber-400 stroke-amber-400"
                                  />{" "}
                                  {req.passengerRating} Rating
                                </span>
                                <span>•</span>
                                <span>
                                  Requested {req.seatsNeeded}{" "}
                                  {req.seatsNeeded === 1 ? "seat" : "seats"}
                                </span>
                              </div>
                            </div>
                        ...
                        <div className="flex flex-col sm:items-end justify-between gap-2.5 sm:text-right shrink-0">
                          <div>
                            ...
                            <span className="text-xl font-extrabold text-primary-blue font-mono">
                              ₹{req.maxPrice}
                            </span>
                          </div>
                          ...
                          <div className="flex gap-2 w-full sm:w-auto">
                            ...
                            <button
                              onClick={() => {
                                triggerMockNotification(
                                  `Contact request sent to ${req.passengerName}! Mobile OTP channel open.`,
                                );
                              }}
        ...
        {isOfferModalOpen && selectedRequestForOffer && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
            ...
            >
              ...
              <form
                onSubmit={handleSendOfferModalSubmit}
                className="p-6 space-y-4 text-left"
              >
                <p className="text-xs text-secondary-text leading-relaxed">
                  Select one of your published rides to offer to{" "}
                  <strong>{selectedRequestForOffer.passengerName}</strong>:
                </p>

                {rides.filter(
                  (r) => r.driverId === user.id && r.status === "active",
                ).length === 0 ? (
                  ...
                  <div>
                    ...
                    >
                      {rides
                        .filter(
                          (r) =>
                            r.driverId === user.id && r.status === "active",
                        )
                        .map((r) => (
