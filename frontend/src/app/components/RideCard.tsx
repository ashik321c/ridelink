...
interface RideCardProps {
  ...
  bookingStatus?: 'pending' | 'accepted' | 'rejected' | 'none';
}

export default function RideCard({ ride, onBook, bookingStatus = 'none' }: RideCardProps) {
  return (
    <motion.div
    ...
    >
      ...
      <div className="flex items-center justify-between border-b border-brand-border pb-4 mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-1.5">
              <h4 className="text-sm font-bold text-primary-text">{ride.driverName}</h4>
            ...
            <div className="flex items-center gap-1 text-xs text-secondary-text">
              ...
              <span className="font-bold text-slate-700">{ride.driverRating}</span>
        ...
        <div className="text-right">
          <p className="text-[10px] uppercase tracking-wider text-secondary-text font-bold">Ride Contribution</p>
      ...
      <div className="space-y-3.5 mb-5 relative pl-4">
        ...
        <div className="flex items-start gap-3 relative">
          ...
          <div>
            <p className="text-xs text-secondary-text font-semibold">Destination</p>
            <p className="text-sm font-bold text-primary-text">{ride.destination}</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          <p className="text-[10px] uppercase tracking-wider text-secondary-text font-bold">Seats Left</p>
          <p className="text-sm font-bold text-primary-text">
            {ride.seatsAvailable} <span className="text-xs font-normal text-secondary-text">/ {ride.totalSeats} seats</span>
          </p>
        </div>
