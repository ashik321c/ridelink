...
import { Car, Menu, X, LogOut, User as UserIcon, LayoutDashboard } from 'lucide-react';
...
export default function Navbar({ activeTab = 'home', setActiveTab }: NavbarProps) {
  ...
  return (
    <>
      <nav className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${scrolled ? 'glass py-3 border-b shadow-sm' : 'bg-transparent py-5'}`}>
          ...
          <div className="flex items-center justify-between">
              ...
              {user ? (
                <div className="flex items-center gap-3">
                  ...
                  <button 
                    ...
                    className="px-3.5 py-1.5 text-xs font-bold text-primary-blue border border-primary-blue/30 rounded-xl hover:bg-primary-blue/5 transition-all"
                  >
            ...
            <div className="md:hidden flex items-center gap-2">
              {user && (
                <button 
                  onClick={toggleUserRole}
                  className="px-2.5 py-1 text-[10px] font-bold text-primary-blue border border-primary-blue/30 rounded-lg"
                >
                  {user.isDriver ? 'Passenger' : 'Driver'}
                </button>
              )}
              <button 
